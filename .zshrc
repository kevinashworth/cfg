...
# Added 2022-06-14 per https://www.atlassian.com/git/tutorials/dotfiles
alias config='/usr/local/bin/git --git-dir=$HOME/.cfg/ --work-tree=$HOME'

# Added 2020-01-30 per command `rbenv init`
# eval "$(rbenv init -)"
...
# Did `brew install rbenv` 2021-01-25 and it finished with next 4 lines:
